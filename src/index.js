const versionHash = "1.1-beta";
const changelog = "Patched autoplace issue";
  ...
  function e() {
    now = Date.now(), delta = now - lastUpdate, lastUpdate = now,
      function () {
        ...
        for (var x = -camX; x < maxScreenWidth; x += maxScreenHeight / 3)
          x > 0 && (mainContext.moveTo(x, 0), mainContext.lineTo(x, maxScreenHeight));
        for (var y = -camY; y < maxScreenHeight; y += maxScreenHeight / 3)
