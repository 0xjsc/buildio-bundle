...
const modulesQueue = [
  ...
  () => {
    ...
    else if (!alreadyWorking && reloads[player.weapons[1]] !== speeds[player.weapons[1]] && player.weaponIndex != player.weapons[1]) io.send(packets.CHANGE_WEAPON, (waka = player.weapons[1]), true);
