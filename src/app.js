...
const modulesQueue = [
  ...
  () => {
    ...
    else if (reloads[player.weapons[0]] == speeds[player.weapons[0]] && reloads[player.weapons[1]] == speeds[player.weapons[1]] && player.weaponIndex != player.weapons[1]) io.send(packets.CHANGE_WEAPON, (waka = player.weapons[1]), true);
