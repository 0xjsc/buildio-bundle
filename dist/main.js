...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _msgpack_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./msgpack.js */ "./src/libs/msgpack.js");
...
const socket = {
  ...
  send(type) {
    const data = Array.prototype.slice.call(arguments, 1),
      binary = _msgpack_js__WEBPACK_IMPORTED_MODULE_0__["default"].encode([
        type,
        data
      ]);
...
function deserialize(array) {
  ...
  function read() {
    ...
    throw new Error("Invalid byte value '" + byte + "' at index " + (pos - 1) + " in the MessagePack binary data (length " + array.length +
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (msgpack);
...
/* harmony import */ var _js_data_gameObject_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/data/gameObject.js */ "./src/js/data/gameObject.js");
/* harmony import */ var _js_data_items_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/data/items.js */ "./src/js/data/items.js");
/* harmony import */ var _js_data_mapManager_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/data/mapManager.js */ "./src/js/data/mapManager.js");
/* harmony import */ var _js_data_objectManager_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/data/objectManager.js */ "./src/js/data/objectManager.js");
/* harmony import */ var _js_data_player_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/data/player.js */ "./src/js/data/player.js");
/* harmony import */ var _js_data_store_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/data/store.js */ "./src/js/data/store.js");
/* harmony import */ var _js_data_projectile_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/data/projectile.js */ "./src/js/data/projectile.js");
/* harmony import */ var _js_data_projectileManager_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./js/data/projectileManager.js */ "./src/js/data/projectileManager.js");
/* harmony import */ var _socket_socket_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./socket/socket.js */ "./src/socket/socket.js");
...
const wsBridge = window.socketController = new _socket_socket_js__WEBPACK_IMPORTED_MODULE_12__["default"](() => _libs_io_client_js__WEBPACK_IMPORTED_MODULE_1__["default"], packets);
...
var useNativeResolution, showPing, delta, now, lastSent, attackState, player, playerSID, tmpObj, camX = 100, camY = 100, tmpDir, screenWidth, screenHeight, moofoll = getSavedVal('moofoll'),
  ...
  gameObjects = [],
  app_projectiles = [],
  projectileManager = new _js_data_projectileManager_js__WEBPACK_IMPORTED_MODULE_11__["default"](_js_data_projectile_js__WEBPACK_IMPORTED_MODULE_10__["default"], app_projectiles, players, ais, objectManager, _js_data_items_js__WEBPACK_IMPORTED_MODULE_5__["default"], _config_js__WEBPACK_IMPORTED_MODULE_3__["default"], _libs_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"]),
  waterMult = 1,
  waterPlus = 0,
  mouseX = 0,
  mouseY = 0,
  ...
  skinColor = 0,
  maxScreenWidth = _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].maxScreenWidth,
...
function sendMoveDir() {
  ...
  (null == lastMoveDir || null == newMoveDir || Math.abs(newMoveDir - lastMoveDir) > 0.3) && (wsBridge.updateMoveDir(newMoveDir), (!window.enemyDanger && !instakilling) && (storeEquip(window.tanker ? 15 : (player.y <= _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].snowBiomeTop ? 6 : 11), true), storeEquip(window.tanker ? 6 : getBiomeHat())), lastMoveDir = newMoveDir);
}
...
function loadGameObject(data) {
  for (var i = 0; i < data.length;)
    objectManager.add(data[i], data[i + 1], data[i + 2], data[i + 3], data[i + 4], data[i + 5], _js_data_items_js__WEBPACK_IMPORTED_MODULE_5__["default"].list[data[i + 6]], !0, data[i + 7] >= 0 ? {
      sid: data[i + 7]
    } : null), i += 8;
}

function wiggleGameObject(dir, sid) {
  (tmpObj = findObjectBySid(sid)) && (tmpObj.xWiggle += _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].gatherWiggle * Math.cos(dir), tmpObj.yWiggle += _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].gatherWiggle * Math.sin(dir));
}

function shootTurret(sid, dir) {
  (tmpObj = findObjectBySid(sid)) && (tmpObj.dir = dir, tmpObj.xWiggle += _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].gatherWiggle * Math.cos(dir + Math.PI), tmpObj.yWiggle += _config_js__WEBPACK_IMPORTED_MODULE_3__["default"].gatherWiggle * Math.sin(dir + Math.PI));
}
